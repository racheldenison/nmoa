function slider = nmMakeSlider(name,range,pos,intFlag,val,flexFlag);
% slider = nmMakeSlider(name,range,pos,[intFlag],val,[flexFlag]);
%
...
% ras 02/05.
%
% Modified from rxMakeSlider - just changed the refresh function to
% nmRefresh
% Rachel Denison
% Jan 2014
